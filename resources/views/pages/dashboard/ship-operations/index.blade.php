    ...
    <div class="container">
        ...
        <div class="content-header">
            <div class="header">
                ...
                <div class="actions">
                    <a class="btn btn-primary" href="{{ route('ship-operations.create') }}">Tambah</a></li>
                </div>
            </div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Operasi Kapal</li>
                </ol>
            </nav>
        </div>
        <!-- content-header:end -->
...
@push('scripts')
    <script>
        // datatables
        const route = "{{ route('ship-operations.index') }}";
        const initTable = () => {

            ...
            <div class="row">
                <div class="col-12">
                    <div class="mt-2">
                        ...
                        <form action="{{ route('routes.update', ['route' => $route->id]) }}" method="POST" autocomplete="off">
                            @csrf
                            @method('PUT')
                            <div class="form-group row my-2">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="departure" class="form-control" autocomplete="off" placeholder="Keberangkatan" value="{{ old('departure', $route->departure) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row my-2">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="arrival" class="form-control" autocomplete="off" placeholder="Kedatangan" value="{{ old('arrival', $route->arrival) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row my-2">

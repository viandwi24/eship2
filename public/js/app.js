...
function initSidebarMobile() {
  ...
  var toggle = function toggle() {
    ...
    if (sidebarMobileState) {
      ...
      setTimeout(function () {
        return sidebar.classList.remove('mobile-show');
      }, 200);
      sidebarOverlay.remove();
    }
  };

  var onrezise = function onrezise() {
...
var loading = {
  show: function show() {
    var overlayLoading = document.querySelector(".loading-overlay");
  ...
  hide: function hide() {
    ...
    if (overlayLoading != null) {
      ...
      setTimeout(function () {
        return overlayLoading.style.display = 'none';
      }, 250);
    }
  }
}; // 
...
var initLinkToggle = function initLinkToggle() {
  var menuLink = document.querySelectorAll('a.toggle');
  menuLink.forEach(function (e) {
    return e.addEventListener('click', /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(a) {
